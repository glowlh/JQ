        ...
        <div>
            <StoryBox>
                ...
                <StoryBoxContent>
                    ...
                    <Chapter>
                        Кем вы были в прошлой жизни? А кем переродитесь в следующей? Может будете <b>якудза</b>, <b>хакером</b>, <b>ученым</b>, <b>человеком из другого времени</b> или <b>богом Кондзин</b>? А может <b>ребенком императора</b> или <b>ниндзя</b>? А может быть <b>детективом по сверхъестественному</b> или <b>самураем</b>? Или может… слизью?
                    </Chapter>
                    <Chapter>
                    ...
                    <Chapter>
                        ...
                        Возможно, это полностью переврнет ваши жизни.
                        Хоть толком ничего и не изменилось.
                        Очень-очень необычное и в то же время заурядное.
                        Из музеев крадут драгоценности, люди исчазают из семей и из своих времен, крадут данные, продают незаконные вещи, охотятся на других людей или просто смеются в стороне над всем происходящем.
